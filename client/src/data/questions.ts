...
export const questionSections: QuestionSection[] = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        description: '본 서비스를 이용함으로써, 귀하는 본 서비스의 [이용약관 및 개인정보 처리방침]에 동의하고, 위 두 법인으로부터 광고성 정보를 수신하는 것에 동의하게 됩니다. 본 웹사이트의 정보는 법률적 조언이 아니며 변호사-의뢰인 관계를 형성하지 않습니다. 본 웹사이트에 게재된 모든 자료들은 저작권법상 보호를 받는 대상이며, 권한 없는 복제나 상업적 서비스로의 어떠한 연결도 금지됩니다.',
        required: true,
        options: [
